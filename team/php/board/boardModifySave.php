...
<!-- //header -->
                        ...
                        <form action="requestSave.php" name="request" method="post" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="mb50">
                                    ...
                                    <a href="requestList.php" class="request-btn mb50">수정하기</a>
                                </div>
                            </fieldset>
                        </form>
                        <?php
                        $requestTitle = $_GET['requestTitle'];
                        $youName = $_GET['youName'];
                        $selectLayout = $_GET['selectLayout'];
                        $regTime = time();
                        $requestContents = $_GET['requestContents'];
                        $photoUpload = $_GET['photoUpload'];
                    
                        $sqlUpdate = "SELECT * FROM myRequest";
                        $sqlUpdate = "UPDATE myRequest SET selectLayout = {$selectLayout}, requestTitle = {$requestTitle}, requestContents = {$requestContents}, requestPhotoName= {$photoUpload}, regTime = {$regTime} WHERE requestID = {$requestID}";
    ...
    <script>
        ...
        // $regTime = time();
        // $requestContents = $_GET['requestContents'];
        // $requestPhotoName = $_GET['requestPhotoName'];
    
        // $sqlUpdate = "SELECT * FROM myRequest";
        // $sqlUpdate = "UPDATE myRequest SET selectLayout = {$selectLayout}, requestTitle = {$requestTitle}, requestContents = {$requestContents}, requestPhotoName= {$requestPhotoName}, regTime = {$regTime} WHERE requestID = {$requestID}";
        // $connect -> query($sqlUpdate);
