...
<main id="contents">
        ...
        <div class="container">
            <h3 class="section__title">문의사항 수정하기</h3>
            <p class="section__desc">문의사항을 수정할 수 있습니다!</p>
            <div class="board__inner">     
                <div class="board__modify">
                    <form action="inquiryModifySave.php" name="boardModify" method="post">
                        <fieldset>
                            <legend class="ir_so">문의사항 수정 영역</legend>
                            <?php
